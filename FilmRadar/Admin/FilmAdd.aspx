<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="FilmAdd.aspx.cs" Inherits="FilmRadar.Admin.FilmAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="userAdd">
        ...
        <div class="row">
            <asp:LinkButton ID="lbtn_add" runat="server" Text="Film Ekle" CssClass="formButton" OnClick="lbtn_add_Click"></asp:LinkButton>
        </div>
    </div>
</asp:Content>
